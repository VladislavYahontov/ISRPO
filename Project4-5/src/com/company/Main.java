...
public class Main
{
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println("---------------------- Доставка из очереди успешна ----------------------");
        ...
        System.out.println("------------ Работа сортировки успешна (первое индивидуальное задание ) -----------");
        ...
        double a ;
        String m ;
        for (j = 0; j < 40 ; j++)                // Цикл с данными из задания
        {
            a =  Math.random()*10;             // Случайное значени от 0 до 10
            m = (int)a + "";
